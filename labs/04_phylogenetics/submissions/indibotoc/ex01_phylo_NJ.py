...
if __name__ == "__main__":
   ...
   fasta = Path("data/work/indibotoc/lab04/indibotoc_seq.fasta")
   if not fasta.exists():
   ...
   out_dir = Path(f"labs/04_phylogenetics/submissions/indibotoc")
   out_dir.mkdir(parents=True, exist_ok=True)
   out_newick = out_dir / f"tree_indibotoc.nwk"
   ...
   out_png = out_dir / f"tree_indibotoc.png"
