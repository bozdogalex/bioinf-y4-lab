...
EXPR_CSV = Path("/workspaces/bioinf-y4-lab/data/work/IrisDanila/lab06/expression_matrix.csv")
MODULES_CSV = Path(f"/workspaces/bioinf-y4-lab/labs/06_wgcna/submissions/{HANDLE}/modules_IrisDanila.csv")

# Parametri pentru reconstrucția adiacenței
...
if __name__ == "__main__": 
    ...
    # 2) Reconstruiți adiacența din corelații
