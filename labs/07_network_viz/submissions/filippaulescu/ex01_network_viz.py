...
# Fișiere de intrare
EXPR_CSV = Path(f"data/work/{HANDLE}/lab06/expression_matrix1.csv")
...
# Dacă ai un fișier de tip adj_filippaulescu.csv din Lab 6, poți decomenta și seta aici calea lui:
