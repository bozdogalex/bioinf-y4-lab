...
**Ex01:**
Pentru început, am folosit scriptul `generate_genes.py` pentru a genera o matrice cu 1.000 de gene si 20 de sample-uri, care au fost salvate in `data/work/indibotoc/lab06/expression_matrix.csv`, pentru a fi folosite la rezolvarea `ex01_gce_networks.py`.
