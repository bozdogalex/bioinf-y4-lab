...
Instrucțiuni:
  - Rulați scriptul cu argumentele necesare (exemple):
      python ex01_multifasta_gc.py --email student@example.com \
        ...
        --retmax 3 \
        --out data/work/<handle>/lab01/vmy_tp53.fa
...
** Rezultate **:
Interogare:
[ok] Am scris 3 înregistrări în: data/work/indibotoc/lab01/my_tp53.fa
NG_017013.2     GC=0.490
NC_060941.1     GC=0.453
NC_000017.11    GC=0.453

Accession:
[ok] Am scris 1 înregistrări în: data/work/indibotoc/lab01/nm000546.fa
