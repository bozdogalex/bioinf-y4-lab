...
Instrucțiuni:
  - Rulați scriptul cu argumentele necesare (exemple):
      python ex01_multifasta_gc.py --email florin.negoita@student.upt.ro --query "TP53[Gene] AND Homo sapiens[Organism]" --retmax 3 --out data/work/Papaia90876/lab01/my_tp53.fa
      python ex01_multifasta_gc.py --email florin.negoita@student.upt.ro --accession NM_000546 --out data/work/Papaia90876/lab01/nm000546.fa
