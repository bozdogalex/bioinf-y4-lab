...
"""
In urma rularii acestei comenzi: 
python "labs/01_intro&databases/ex01_multifasta_gc.py" \
--email filippaulescu@student.upt.com \
--query "TP53[Gene] AND Homo sapiens[Organism]" \
--retmax 3 \
--out data/work/filippaulescu/lab01/my_tp53.fa

Am primit acest rezultat: 
[ok] Am scris 3 înregistrări în: data/work/filippaulescu/lab01/my_tp53.fa
NG_017013.2     GC=0.490
NC_060941.1     GC=0.453
NC_000017.11    GC=0.453

In urma rularii acestei comezni:
python "labs/01_intro&databases/ex01_multifasta_gc.py" \
  --email filippaulescu@student.upt.com \
  --accession NM_000546 \
  --out data/work/filippaulescu/lab01/nm000546.fa

Am primit acest rezultat:
[ok] Am scris 1 înregistrări în: data/work/filippaulescu/lab01/nm000546.fa
