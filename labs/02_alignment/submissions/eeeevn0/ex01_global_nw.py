...
def main():
    ...
    ap.add_argument("--k", type=int, default=300, help="Folosește doar primele k baze din fiecare secvență")
    ...
    s1, s2 = s1[:args.k], s2[:args.k]
    print(f"[info] Se folosesc doar primele {len(s1)} baze din fiecare secvență.")
